...
in this feature so far lived in a _specific_ source/destination pair and was
...
| Custom widget | a trigger on custom widget **A** | carries `eventName` + `customWidgetId` of a _specific_ widget type |
